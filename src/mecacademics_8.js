        ...
        <>
            <div class="mec1body">
                ...
                <div className="bg"style={{ fontFamily: 'Poppins, sans-serif',marginTop:'110px' }}>
                    <h2 className="text-center mt-3 p-3 fw-bold" style={{letterSpacing:'1.5px'}}>SEMESTER <span>8</span></h2>
                    ...
                    <div className=" justify-content-center d-flex mt-3 p-3">
                        <div className="col-lg-10 table-responsive">
                            <table className="table  table-bordered table-hover table-responisve text-nowrap " style={{border:'2px solid black'}}>
                    ...
                    <div class="demo mt-5">
                            <nav class="pagination-outer" aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a href="./mecsem7" class="page-link" aria-label="Previous">
                                    ...
                                    <li class="page-item active"><a class="page-link" href="./mecsem8">8</a></li>
                                    <li class="page-item">
                                        <a href="./mecsem1" class="page-link" aria-label="Next">
                                            <span aria-hidden="true">»</span>
                                        </a>
                                    </li>
                                </ul>
