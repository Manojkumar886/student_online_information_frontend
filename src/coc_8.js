        ...
        <>
            <div class="cocbody">
                ...
                <nav class="navbar fixed-top navbar-expand-custom navbar-mainbg">
                        ...
                        <h2 className="text-center fw-bold" style={{letterSpacing:'1.5px'}}>SEMESTER <i class="bi bi-8-circle-fill"></i></h2>
                        ...
                        <div class="demo mt-5">
                                <nav class="pagination-outer" aria-label="Page navigation">
                                    <ul class="pagination">
                                        <li class="page-item">
                                            <a href="./cocsem7" class="page-link" aria-label="Previous">
                                        ...
                                        <li class="page-item active"><a class="page-link" href="./cocsem8" data-hover="8">8</a></li>
                                        <li class="page-item">
                                            <a href="./cocsem1" class="page-link" aria-label="Next">
                                                <span aria-hidden="true">»</span>
                                            </a>
                                        </li>
                                    </ul>
