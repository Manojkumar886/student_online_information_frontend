        ...
        <>
            <div class="mec1body">
                ...
                <div className="bg"style={{ fontFamily: 'Poppins, sans-serif',marginTop:'110px' }}>
                    <h2 className="text-center mt-3 p-3 fw-bold" style={{letterSpacing:'1.5px'}}>SEMESTER <span><i class="bi bi-5-circle-fill"></i></span></h2>
                    <div className=" justify-content-center d-flex mt-3 p-3">
                        <div className="table-responsive-md col-lg-10  ">
                            <table className="table-responsive table-bordered table-hover table text-nowrap " style={{border: '2px solid black'}}>
                                <tbody>
                                    <tr>
                                        <th>Duration</th>
                                        <td>2020</td>
                    ...
                    <div className=" justify-content-center d-flex mt-3 p-3">
                        <div className="table-responsive col-lg-10  ">
                            <table className="table-responsive table-responsive table-bordered table text-nowrap " style={{border: '2px solid black'}}>
                    ...
                    <div className=" justify-content-center d-flex mt-3 p-3">
                        <div className="col-lg-10 table-responsive">
                            <table className="table  table-bordered table-responsive text-nowrap " style={{border:'2px solid black'}}>
                    ...
                    <div class="demo mt-5">
                            <nav class="pagination-outer" aria-label="Page navigation">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item">
                                        <a href="./mecsem6" class="page-link" aria-label="Next">
                                            <span aria-hidden="true">»</span>
                                        </a>
                                    </li>
                                </ul>
