        ...
        <>
            <div class="mec1body">
                ...
                <div className="bg"style={{ fontFamily: 'Poppins, sans-serif',marginTop:'110px' }}>
                    <h2 className="text-center mt-3 p-3 fw-bold" style={{letterSpacing:'1.5px'}}>SEMESTER <span><i class="bi bi-6-circle-fill"></i></span></h2>
                    ...
                    <div className=" justify-content-center d-flex mt-3 p-3">
                        <div className="col-lg-10 table-responsive">
                            <table className="table  table-bordered table-hover table-responsive text-nowrap " style={{border:'2px solid black'}}>
                    ...
                    <div class="demo mt-5">
                            <nav class="pagination-outer" aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a href="./mecsem5" class="page-link" aria-label="Previous">
