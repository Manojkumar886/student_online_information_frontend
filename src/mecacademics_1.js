        ...
        <>
            <div class="mec1body">
                ...
                <div className="bg" style={{ fontFamily: 'Poppins, sans-serif',marginTop:'110px' }}>
                    <h2 className="text-center mt-3 fw-bold" style={{letterSpacing:'1.5px'}} >SEMESTER <span><i class="bi bi-1-circle-fill"></i></span></h2>
                    ...
                    <div className=" justify-content-center d-flex mt-3 p-3">
                        <div className="col-lg-10 table-responsive">
                            <table className="table table-hover table-bordered text-nowrap table-responsive" style={{border:'2px solid black'}}>
                    ...
                    <div class="demo mt-5">
                            <nav class="pagination-outer" aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a href="./mecsem8" class="page-link" aria-label="Previous">
                                            <span aria-hidden="true">«</span>
                                        </a>
                                    </li>
                                    <li class="page-item active"><a class="page-link" href="./mecsem1">1</a></li>
                                    ...
                                    <li class="page-item">
                                        <a href="./mecsem2" class="page-link " aria-label="Next">
                                            <span aria-hidden="true">»</span>
                                        </a>
                                    </li>
                                </ul>
