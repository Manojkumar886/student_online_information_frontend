...
export const SignupForm = () => {
    ...
    const register = async () => {
        const t = await onCreate(process);
        alert(t);
                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                <div className="col">
                                    ...
                                    <input className="form-control mt-2 "
                                        type="text" placeholder='e.g 2020-2024'
                                        name='studentBatch'
                                        onChange={onGet}
                            ...
                            <div className="row">
                                <div className="col">
                                    <label className="fl form-label float-start fw-bold">StudentRegulation</label>
                                    <input className="form-control mt-2" type="number" min="2000" max="2040"
                            ...
                            <div className="row">
                                <div className="col">
                                    <label className="fl form-label float start fw-bold ">CHOOSE YOUR QUOTA</label>
                                    <br></br>
                                    <select className='form-select' style={{ backgroundColor: '#fafafa' }}
                                        name='studentQuota'
