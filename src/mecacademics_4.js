        ...
        <>
            <div class="mec1body">
                ...
                <div className="bg"style={{ fontFamily: 'Poppins, sans-serif',marginTop:'110px' }}>
                    <h2 className="text-center mt-3 p-3 fw-bold" >SEMESTER <span><i class="bi bi-4-circle-fill"></i></span></h2>
                    ...
                    <div class="demo mt-5">
                            <nav class="pagination-outer" aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a href="./mecsem3" class="page-link" aria-label="Previous">
                                    ...
                                    <li class="page-item active"><a class="page-link" href="./mecsem4">4</a></li>
                                    ...
                                    <li class="page-item">
                                        <a href="./mecsem5" class="page-link" aria-label="Next">
                                            <span aria-hidden="true">»</span>
                                        </a>
                                    </li>
                                </ul>
